...
PROP_SEAT_BELT_BUCKLED_FRONT_LEFT = PROP_HVAC_AC_ON
PROP_SEAT_BELT_BUCKLED_FRONT_RIGHT = PROP_HVAC_AUTO_ON
PROP_SEAT_BELT_BUCKLED_BACK_LEFT = PROP_HVAC_POWER_ON
